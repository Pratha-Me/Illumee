    ...
    return (
      <React.Fragment>
        ...
        <div className="illumee-body">
          ...
          <RedRelativeComp
            image={this.state.redRelativeComp.image1}
            alt={this.state.redRelativeComp.alt1}
            text={this.state.redRelativeComp.text1}
          />
          ...
          <RedRelativeComp
            image={this.state.redRelativeComp.image2}
            alt={this.state.redRelativeComp.alt2}
            text={this.state.redRelativeComp.text2}
          />
        </div>
