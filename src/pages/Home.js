                ...
                <div className="illumee-body">
                    ...
                    <div className="red-bg-div">
                        ...
                        <div className="grid-container">
                            <img className="img-a" src= {icon1} alt="icon1"></img>
                            <img className="img-b" src= {icon2} alt="icon2"></img>
                            <img className="img-c" src= {icon3} alt="icon3"></img>
                            <img className="img-d" src= {icon4} alt="icon4"></img>
                        </div>

                        <p className="body-p">
                            At ILLUMEE, we know that creating a live conference may come with various obstacles, scheduling a date,
                            booking a venue, and getting to the venue itself. For the people attending the conferences and seeking the knowledge
                            from these events are challenging to deal with, now you can create or attend conferences/lectures from the comfort
                            of your own home or office. You are thus saving time, enabling you to focus on what’s more important.
                        </p>
                    </div>
